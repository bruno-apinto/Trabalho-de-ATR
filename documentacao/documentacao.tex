...
\section{Proposta de Arquitetura}
    ...
    a aplicação dos conceitos, por isso a utilização máxima de threads. A partir dos requsiitos mínimos,
...
\begin{figure}[ht]
  ...
  \caption{Proposta de arquitetura para o trabalho prático. Losangos representam processos e círculos representam threads.}
