...
Apesar disso, os testes ainda foram realizados com dados simulados e em ambiente controlado. A validação completa do sistema dependerá da etapa seguinte, na qual serão incorporadas as interfaces de operação remota, simulação física, comunicação MQTT e testes de tempo de resposta, escalonabilidade e a finalização do programa.
